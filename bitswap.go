...
import (
	...
	deciface "github.com/Genon2/ipfs-thesis-bitswap/decision"
	bsbpm "github.com/Genon2/ipfs-thesis-bitswap/internal/blockpresencemanager"
	"github.com/Genon2/ipfs-thesis-bitswap/internal/decision"
	"github.com/Genon2/ipfs-thesis-bitswap/internal/defaults"
	bsgetter "github.com/Genon2/ipfs-thesis-bitswap/internal/getter"
	bsmq "github.com/Genon2/ipfs-thesis-bitswap/internal/messagequeue"
	"github.com/Genon2/ipfs-thesis-bitswap/internal/notifications"
	bspm "github.com/Genon2/ipfs-thesis-bitswap/internal/peermanager"
	bspqm "github.com/Genon2/ipfs-thesis-bitswap/internal/providerquerymanager"
	...
	bssm "github.com/Genon2/ipfs-thesis-bitswap/internal/sessionmanager"
	bsspm "github.com/Genon2/ipfs-thesis-bitswap/internal/sessionpeermanager"
...
func (bs *Bitswap) ReceiveMessage(ctx context.Context, p peer.ID, incoming bsmsg.BitSwapMessage) {
	...
	if len(iblocks) > 0 {
		...
		for _, b := range iblocks {
			...
			// fmt.Printf("Received CID=%s, peer=%s\n", b.Cid().String(), p.String())
		}
	}
